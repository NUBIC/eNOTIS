...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/database_cleaner-0.5.0/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/couchrest-0.34/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/couchrest-0.34/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/polyglot-0.3.0/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/polyglot-0.3.0/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/treetop-1.4.4/bin")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/capistrano-2.5.16/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/gemcutter-0.4.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/gemcutter-0.4.1/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rubytree-0.6.2/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rubytree-0.6.2/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/stomp-1.1.4/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/stomp-1.1.4/lib")
  ...
  @bundled_specs["database_cleaner"].loaded_from = "#{dir}/specifications/database_cleaner-0.5.0.gemspec"
  ...
  @bundled_specs["couchrest"] = eval(File.read("#{dir}/specifications/couchrest-0.34.gemspec"))
  @bundled_specs["couchrest"].loaded_from = "#{dir}/specifications/couchrest-0.34.gemspec"
  ...
  @bundled_specs["polyglot"] = eval(File.read("#{dir}/specifications/polyglot-0.3.0.gemspec"))
  @bundled_specs["polyglot"].loaded_from = "#{dir}/specifications/polyglot-0.3.0.gemspec"
  ...
  @bundled_specs["treetop"] = eval(File.read("#{dir}/specifications/treetop-1.4.4.gemspec"))
  ...
  @bundled_specs["capistrano"].loaded_from = "#{dir}/specifications/capistrano-2.5.16.gemspec"
  ...
  @bundled_specs["gemcutter"] = eval(File.read("#{dir}/specifications/gemcutter-0.4.1.gemspec"))
  @bundled_specs["gemcutter"].loaded_from = "#{dir}/specifications/gemcutter-0.4.1.gemspec"
  ...
  @bundled_specs["rubytree"] = eval(File.read("#{dir}/specifications/rubytree-0.6.2.gemspec"))
  @bundled_specs["rubytree"].loaded_from = "#{dir}/specifications/rubytree-0.6.2.gemspec"
  ...
  @bundled_specs["stomp"] = eval(File.read("#{dir}/specifications/stomp-1.1.4.gemspec"))
  @bundled_specs["stomp"].loaded_from = "#{dir}/specifications/stomp-1.1.4.gemspec"
