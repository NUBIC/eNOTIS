...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/haml-2.2.19/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/haml-2.2.19/lib")
  ...
  @bundled_specs["haml"] = eval(File.read("#{dir}/specifications/haml-2.2.19.gemspec"))
  @bundled_specs["haml"].loaded_from = "#{dir}/specifications/haml-2.2.19.gemspec"
