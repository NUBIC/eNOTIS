...
class StudyUpload < ActiveRecord::Base
  ...
  # Mixins
  has_attached_file :upload,:path=> "/var/www/data/uploads/:id/:style/:basename.:extension"
  has_attached_file :result,:path=> "/var/www/data/results/:id/:style/:basename.:extension"
