...
JOBS_PER_FORK=100 COUNT=6 QUEUES=redis_authorized_personnel_populator,redis_ldapper,redis_bogus_netid rake environment resque:workers
JOBS_PER_FORK=100 COUNT=3 QUEUES=redis_ldapper,redis_bogus_netid rake environment resque:workers
