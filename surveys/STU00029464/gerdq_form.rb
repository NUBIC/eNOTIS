survey "GerdQ",:irb_number=>"STU00029464",:score_configurations_attributes=>[{:name=>"Total Score",:algorithm=>'total_sum'},{:name=>"Disease Impact Score",:algorithm=>'partial_sum',:question_code=>'disease_impact'}] do
