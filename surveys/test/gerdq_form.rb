survey "GerdQ",:irb_number=>"STU009999003"  do
  ...
  section "GerdQ" do
    ...
    q_ec_gerdq2 "How often dif you have stomach contents (liquid or food) moving upwards to your throat or mouth (regurgitation)?",:pick=>:one
      a_0 "0 days",:weight=>0
      a_1 "1 day",:weight=>1
      a_2 "2-3 days",:weight=>2
      a_3 "4-7 days",:weight=>3
