def promis_measure_qol
  section "QOL" do
    ...
    grid "" do
      a_1 "1 = Never", :display_order => 0
      a_2 "2 = Rarely", :display_order => 1
      a_3 "3 = Sometimes", :display_order => 2
      a_4 "4 = Often", :display_order => 3
      a_5 "5 = Always", :display_order => 4
    ...
    grid "" do
      a_1 "1 = None", :display_order => 0
      a_2 "2 = Mild", :display_order => 1
      a_3 "3 = Moderate", :display_order => 2
      a_4 "4 = Severe", :display_order => 3
      a_5 "5 = Very severe", :display_order => 4
            
      q "In the past 7 days, how would you rate your fatigue on average?", :pick => :one
    end
    
    grid "" do
      a_0 "0 = no pain", :display_order => 0
      ...
      a_10 "10 = worst pain imaginable", :display_order => 10
