def therapeutic_alliance
  section "T-ALL" do
    ...
    label_1_3 "If the statement describes the way you <b>always</b> feel (or think) select the number <b>7</b>; if it <b>never</b> applies to you select the number <b>1</b>. 
